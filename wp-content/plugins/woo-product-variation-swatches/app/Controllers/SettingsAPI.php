	...
	public function add_admin_bar() {
		...
		if ( class_exists( 'WooCommerce' ) ) {
			$wp_admin_bar->add_menu( array(
				...
				'title'  => esc_html__( 'Clear transient', 'woo-product-variation-swatches' ),
        ...
        <div id="rtwpvs-settings-container">
            ...
            <div class="rtwpvs-doc-wrapper rt-doc-wrapper">
                <div class="rt-pro-btn-wrap rt-doc-box">
                    <a target="_blank" href="https://www.radiustheme.com/downloads/woocommerce-variation-swatches/" class="rt-pro-btn rt-btn">Update Pro To Get More Advantage Features</a>
                </div>
